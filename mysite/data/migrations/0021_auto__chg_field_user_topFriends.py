...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.topFriends'
        db.alter_column(u'data_user', 'topFriends', self.gf('data.models.ListField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.topFriends'
        db.alter_column(u'data_user', 'topFriends', self.gf('data.models.ListField')(default=''))
