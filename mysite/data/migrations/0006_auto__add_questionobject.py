...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionObject'
        db.create_table(u'data_questionobject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('toUser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qo_to_user', to=orm['data.User'])),
            ('product1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qo_product1', to=orm['data.Product'])),
            ('image1', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('product2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qo_product2', to=orm['data.Product'])),
            ...
            ('currentQuestion', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qo_currentQuestion', to=orm['data.Question'])),
        ...
        db.send_create_signal(u'data', ['QuestionObject'])


    def backwards(self, orm):
        # Deleting model 'QuestionObject'
        db.delete_table(u'data_questionobject')
