...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.topFriends'
        db.add_column(u'data_user', 'topFriends',
                      self.gf('data.models.ListField')(default=[]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.topFriends'
        db.delete_column(u'data_user', 'topFriends')
