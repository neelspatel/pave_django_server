...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserGeneratedQuestion.fbFriend1'
        db.add_column(u'data_usergeneratedquestion', 'fbFriend1',
                      self.gf('data.models.ListField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'UserGeneratedQuestion.fbFriend2'
        db.add_column(u'data_usergeneratedquestion', 'fbFriend2',
                      self.gf('data.models.ListField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserGeneratedQuestion.fbFriend1'
        db.delete_column(u'data_usergeneratedquestion', 'fbFriend1')

        # Deleting field 'UserGeneratedQuestion.fbFriend2'
        db.delete_column(u'data_usergeneratedquestion', 'fbFriend2')
