...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.anonymousUser'
        db.add_column(u'data_answer', 'anonymousUser',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='a_user', null=True, to=orm['data.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.anonymousUser'
        db.delete_column(u'data_answer', 'anonymousUser_id')
