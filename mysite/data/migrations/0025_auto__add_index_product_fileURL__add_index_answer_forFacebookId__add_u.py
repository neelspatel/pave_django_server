...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Product', fields ['fileURL']
        db.create_index(u'data_product', ['fileURL'])

        # Adding index on 'Answer', fields ['forFacebookId']
        db.create_index(u'data_answer', ['forFacebookId'])

        # Adding unique constraint on 'Notification', fields ['user']
        db.create_unique(u'data_notification', ['user_id'])

        # Adding index on 'UserGeneratedProduct', fields ['fileURL']
        db.create_index(u'data_usergeneratedproduct', ['fileURL'])

        # Adding index on 'TrainingProduct', fields ['fileURL']
        db.create_index(u'data_trainingproduct', ['fileURL'])

        # Adding unique constraint on 'ProductType', fields ['text']
        db.create_unique(u'data_producttype', ['text'])

        # Adding unique constraint on 'TrainingProductType', fields ['text']
        db.create_unique(u'data_trainingproducttype', ['text'])

        # Adding index on 'FeedObject', fields ['forUser']
        db.create_index(u'data_feedobject', ['forUser'])


    def backwards(self, orm):
        # Removing index on 'FeedObject', fields ['forUser']
        db.delete_index(u'data_feedobject', ['forUser'])

        # Removing unique constraint on 'TrainingProductType', fields ['text']
        db.delete_unique(u'data_trainingproducttype', ['text'])

        # Removing unique constraint on 'ProductType', fields ['text']
        db.delete_unique(u'data_producttype', ['text'])

        # Removing index on 'TrainingProduct', fields ['fileURL']
        db.delete_index(u'data_trainingproduct', ['fileURL'])

        # Removing index on 'UserGeneratedProduct', fields ['fileURL']
        db.delete_index(u'data_usergeneratedproduct', ['fileURL'])

        # Removing unique constraint on 'Notification', fields ['user']
        db.delete_unique(u'data_notification', ['user_id'])

        # Removing index on 'Answer', fields ['forFacebookId']
        db.delete_index(u'data_answer', ['forFacebookId'])

        # Removing index on 'Product', fields ['fileURL']
        db.delete_index(u'data_product', ['fileURL'])
    ...
    models = {
        u'data.answer': {
            ...
            'forFacebookId': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
        ...
        u'data.feedobject': {
            ...
            'fbFriend1': ('data.models.ListField', [], {'null': 'True'}),
            'fbFriend2': ('data.models.ListField', [], {'null': 'True'}),
            'forUser': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'data.notification': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.User']", 'unique': 'True'})
        },
        u'data.product': {
            'Meta': {'object_name': 'Product'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'fileURL': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'data.recommendation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rec': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data.ToRecommend']"}),
        ...
        u'data.user': {
            ...
            'topFriends': ('data.models.ListField', [], {'null': 'True', 'blank': 'True'})
        },
