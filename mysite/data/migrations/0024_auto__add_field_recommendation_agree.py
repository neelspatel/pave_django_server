...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recommendation.agree'
        db.add_column(u'data_recommendation', 'agree',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recommendation.agree'
        db.delete_column(u'data_recommendation', 'agree')
