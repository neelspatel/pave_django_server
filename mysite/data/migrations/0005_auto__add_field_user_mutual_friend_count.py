...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.mutual_friend_count'
        db.add_column(u'data_user', 'mutual_friend_count',
                      self.gf('data.models.ListField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.mutual_friend_count'
        db.delete_column(u'data_user', 'mutual_friend_count')
