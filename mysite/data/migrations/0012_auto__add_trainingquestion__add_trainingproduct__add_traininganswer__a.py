...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrainingQuestion'
        db.create_table(u'data_trainingquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.TrainingProductType'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('on', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'data', ['TrainingQuestion'])

        # Adding model 'TrainingProduct'
        db.create_table(u'data_trainingproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('on', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.TrainingProductType'])),
        ...
        db.send_create_signal(u'data', ['TrainingProduct'])

        # Adding model 'TrainingAnswer'
        db.create_table(u'data_traininganswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.User'])),
            ('wrongProduct', self.gf('django.db.models.fields.related.ForeignKey')(related_name='t_wrong_product', to=orm['data.TrainingProduct'])),
            ('chosenProduct', self.gf('django.db.models.fields.related.ForeignKey')(related_name='t_chosen_product', to=orm['data.TrainingProduct'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='t_question', to=orm['data.TrainingQuestion'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'data', ['TrainingAnswer'])

        # Adding model 'TrainingProductType'
        db.create_table(u'data_trainingproducttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'data', ['TrainingProductType'])


    def backwards(self, orm):
        # Deleting model 'TrainingQuestion'
        db.delete_table(u'data_trainingquestion')

        # Deleting model 'TrainingProduct'
        db.delete_table(u'data_trainingproduct')

        # Deleting model 'TrainingAnswer'
        db.delete_table(u'data_traininganswer')

        # Deleting model 'TrainingProductType'
        db.delete_table(u'data_trainingproducttype')
    ...
    models = {
        ...
        u'data.user': {
            ...
            'topFriends': ('data.models.ListField', [], {})
        },
