...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.status_score'
        db.add_column(u'data_notification', 'status_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.status_score'
        db.delete_column(u'data_notification', 'status_score')
