...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionObject.aboutFriend'
        db.add_column(u'data_questionobject', 'aboutFriend',
                      self.gf('django.db.models.fields.CharField')(default='4', max_length=200),
                      keep_default=False)

        # Adding field 'QuestionObject.aboutFriendName'
        db.add_column(u'data_questionobject', 'aboutFriendName',
                      self.gf('django.db.models.fields.CharField')(default='Nithin Tumma', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionObject.aboutFriend'
        db.delete_column(u'data_questionobject', 'aboutFriend')

        # Deleting field 'QuestionObject.aboutFriendName'
        db.delete_column(u'data_questionobject', 'aboutFriendName')
