...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedObject.fbFriend1'
        db.alter_column(u'data_feedobject', 'fbFriend1', self.gf('data.models.ListField')(null=True))

        # Changing field 'FeedObject.fbFriend2'
        db.alter_column(u'data_feedobject', 'fbFriend2', self.gf('data.models.ListField')(null=True))

    def backwards(self, orm):

        # Changing field 'FeedObject.fbFriend1'
        db.alter_column(u'data_feedobject', 'fbFriend1', self.gf('data.models.ListField')(default=[]))

        # Changing field 'FeedObject.fbFriend2'
        db.alter_column(u'data_feedobject', 'fbFriend2', self.gf('data.models.ListField')(default=''))
