...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.male_friends'
        db.add_column(u'data_user', 'male_friends',
                      self.gf('data.models.ListField')(null=True),
                      keep_default=False)

        # Adding field 'User.female_friends'
        db.add_column(u'data_user', 'female_friends',
                      self.gf('data.models.ListField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.male_friends'
        db.delete_column(u'data_user', 'male_friends')

        # Deleting field 'User.female_friends'
        db.delete_column(u'data_user', 'female_friends')
