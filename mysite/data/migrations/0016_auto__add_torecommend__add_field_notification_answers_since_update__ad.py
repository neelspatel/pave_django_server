...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ToRecommend'
        db.create_table(u'data_torecommend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'data', ['ToRecommend'])

        # Adding field 'Notification.answers_since_update'
        db.add_column(u'data_notification', 'answers_since_update',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Notification.rec_ready'
        db.add_column(u'data_notification', 'rec_ready',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Recommendation.delivered'
        db.add_column(u'data_recommendation', 'delivered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ToRecommend'
        db.delete_table(u'data_torecommend')

        # Deleting field 'Notification.answers_since_update'
        db.delete_column(u'data_notification', 'answers_since_update')

        # Deleting field 'Notification.rec_ready'
        db.delete_column(u'data_notification', 'rec_ready')

        # Deleting field 'Recommendation.delivered'
        db.delete_column(u'data_recommendation', 'delivered')
