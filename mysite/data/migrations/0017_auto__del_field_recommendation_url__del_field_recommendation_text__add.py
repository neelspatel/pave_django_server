...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recommendation.url'
        db.delete_column(u'data_recommendation', 'url')

        # Deleting field 'Recommendation.text'
        db.delete_column(u'data_recommendation', 'text')

        # Adding field 'Recommendation.rec'
        db.add_column(u'data_recommendation', 'rec',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['data.ToRecommend']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Recommendation.url'
        db.add_column(u'data_recommendation', 'url',
                      self.gf('django.db.models.fields.CharField')(default='www.yahoo.com', max_length=200),
                      keep_default=False)

        # Adding field 'Recommendation.text'
        db.add_column(u'data_recommendation', 'text',
                      self.gf('django.db.models.fields.CharField')(default='Old Rec', max_length=200),
                      keep_default=False)

        # Deleting field 'Recommendation.rec'
        db.delete_column(u'data_recommendation', 'rec_id')
