...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.last_rec_update'
        db.add_column(u'data_notification', 'last_rec_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.last_rec_update'
        db.delete_column(u'data_notification', 'last_rec_update')
