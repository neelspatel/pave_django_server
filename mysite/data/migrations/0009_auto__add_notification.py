...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.User'])),
            ('number_answers', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('number_ug_answers', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('number_recs', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'data', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table(u'data_notification')
